...
export default function Hero() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 min-h-[calc(100vh-80px)] flex items-center">
      ...
      <div className="mx-auto max-w-7xl px-6 w-full lg:flex lg:px-8 items-center justify-between gap-12 py-10 lg:py-0">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl z-10 relative">
          ...
          <p className="mt-6 text-base sm:text-lg leading-8 text-gray-300 max-w-lg">
        ...
        <div className="mx-auto mt-10 lg:mt-0 flex max-w-2xl lg:max-w-none relative z-10 lg:flex-1 justify-center lg:justify-end">
          <div className="w-full max-w-md xl:max-w-lg relative">
            ...
            {/* Floating stats card */}
            <div className="absolute -bottom-6 -left-6 sm:-bottom-8 sm:-left-8 bg-white/10 backdrop-blur-md border border-white/20 p-4 sm:p-5 rounded-2xl shadow-xl z-20 hidden sm:block">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="bg-purple-500/20 p-2 sm:p-3 rounded-full">
                  <Zap className="h-5 w-5 sm:h-6 sm:w-6 text-purple-300" />
                </div>
                <div>
                  <p className="text-xs sm:text-sm text-gray-300 font-medium">Energy Efficiency</p>
                  <p className="text-xl sm:text-2xl font-bold text-white">A+++ Rating</p>
                </div>
              </div>
            </div>
          </div>
