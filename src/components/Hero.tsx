...
export default function Hero() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 min-h-[100dvh] flex items-center pt-24 pb-12 sm:pt-0 sm:pb-0">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 w-full lg:flex lg:px-8 items-center justify-between gap-8 lg:gap-12">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl z-10 relative text-center lg:text-left">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white leading-[1.1] sm:leading-[1.1]">
          ...
          <p className="mt-6 text-sm sm:text-base lg:text-lg leading-7 sm:leading-8 text-gray-300 max-w-lg mx-auto lg:mx-0">
