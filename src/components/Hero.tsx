      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 w-full lg:flex lg:px-8 items-center justify-between gap-8 lg:gap-12">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl z-10 relative text-center lg:text-left">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold tracking-tight text-white leading-[1.1] sm:leading-[1.1]">
            Claim Your <br className="hidden sm:block lg:hidden" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-200">£7,500</span> Grant Today
          </h1>
